...
const fixtureV16 = fileURLToPath(new URL('../../fixtures/harbor-east-v16.ifc', import.meta.url));
const fixtureV17 = fileURLToPath(new URL('../../fixtures/harbor-east-v17.ifc', import.meta.url));
